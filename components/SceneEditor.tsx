    ...
    <div className="bg-purple-950 p-4 sm:p-6 rounded-xl shadow-2xl">
      ...
      <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2">
        {scenes.map((scene, index) => (
          <div key={scene.id} className="bg-purple-900 p-4 rounded-lg shadow-md">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full p-2 bg-purple-950 border border-purple-800 rounded-md text-gray-200 focus:ring-fuchsia-500 focus:border-fuchsia-500"
