  ...
  return (
    <div className="bg-gray-800 p-4 sm:p-6 rounded-xl shadow-2xl">
              ...
              <div className="space-y-3">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    disabled={isGenerating}
                    className="px-3 py-1.5 text-sm bg-green-600 hover:bg-green-700 rounded-md text-white disabled:opacity-50"
                  >
                    Save Changes
                  </button>
                  <button
              ...
              <div className="space-y-2">
                ...
                <div className="flex space-x-2 mt-2 flex-wrap gap-2">
                  <button
                    ...
                    className="px-3 py-1.5 text-xs bg-blue-600 hover:bg-blue-700 rounded-md text-white disabled:opacity-50"
                  >
                    Edit Scene
                  </button>
                  <button
      ...
      <button
        onClick={onAddScene}
        disabled={isGenerating}
        className="mt-6 w-full px-4 py-2 bg-indigo-600 hover:bg-indigo-700 rounded-md text-white font-medium disabled:opacity-50"
      >
        Add New Scene
      </button>
    </div>
