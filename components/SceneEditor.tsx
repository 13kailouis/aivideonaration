...
const SceneEditor: React.FC<SceneEditorProps> = ({
  ...
  return (
    <div className="bg-gray-900 border border-gray-700 p-4 sm:p-6 rounded-xl shadow-2xl">
      <h3 className="text-xl sm:text-2xl font-semibold mb-4 text-teal-400" style={{ fontFamily: 'Fira Code' }}>4. Edit Scenes</h3>
      ...
      <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2">
        {scenes.map((scene, index) => (
          <div key={scene.id} className="bg-gray-900 border border-gray-700 p-4 rounded-lg shadow-md">
            <h4 className="font-semibold text-teal-300 mb-2" style={{ fontFamily: 'Fira Code' }}>Scene {index + 1}</h4>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full p-2 bg-gray-900 border border-gray-700 rounded-md text-gray-200 focus:ring-teal-500 focus:border-teal-500"
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    disabled={isGenerating}
                    className="px-3 py-1.5 text-sm bg-teal-600 hover:bg-teal-500 rounded-md text-white disabled:opacity-50"
                  >
                    Save Changes
                  </button>
                  <button
              ...
              <div className="space-y-2">
                ...
                <div className="flex space-x-2 mt-2 flex-wrap gap-2">
                  <button
                    ...
                    className="px-3 py-1.5 text-xs bg-teal-600 hover:bg-teal-500 rounded-md text-white disabled:opacity-50"
                  >
                    Edit Scene
                  </button>
                  <button
                    ...
                    className="px-3 py-1.5 text-xs bg-teal-600 hover:bg-teal-500 rounded-md text-white disabled:opacity-50 flex items-center"
      ...
      <button
        onClick={onAddScene}
        disabled={isGenerating}
        className="mt-6 w-full px-4 py-2 bg-teal-600 hover:bg-teal-500 rounded-md text-white font-medium disabled:opacity-50"
      >
        Add New Scene
      </button>
    </div>
