    ...
    <div className="p-4 bg-gray-900 border border-gray-700 rounded-lg shadow-lg space-y-6">
          ...
          {(['16:9', '9:16'] as AspectRatio[]).map((ratio) => (
            <button
              ...
              className={`flex-1 p-3 rounded-md text-sm font-medium transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-teal-500
                ${aspectRatio === ratio ? 'bg-teal-600 text-white shadow-md' : 'bg-gray-800 text-gray-300 hover:bg-gray-700'}
      ...
      <div>
        <label htmlFor="useAiImages" className="flex items-center text-sm font-medium text-gray-300 mb-1 cursor-pointer select-none">
          <input
            ...
            className="h-4 w-4 text-teal-600 border-gray-600 rounded focus:ring-teal-500 bg-gray-800 mr-2 disabled:opacity-50"
          />
      ...
      <button
        ...
        className={`w-full flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white
                  ${!canGenerate ? 'bg-gray-600 cursor-not-allowed' : 'bg-teal-600 hover:bg-teal-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-teal-500'}
