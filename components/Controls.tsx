...
const Controls: React.FC<ControlsProps> = ({
  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-lg space-y-6">
        ...
        <div className="flex space-x-2">
          {(['16:9', '9:16'] as AspectRatio[]).map((ratio) => (
            <button
              ...
              className={`flex-1 p-3 rounded-md text-sm font-medium transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-indigo-500
                ${aspectRatio === ratio ? 'bg-indigo-600 text-white shadow-md' : 'bg-gray-200 text-gray-700 hover:bg-gray-100'}
      ...
      <div>
        <label htmlFor="useAiImages" className="flex items-center text-sm font-medium text-gray-700 mb-1 cursor-pointer select-none">
          <input
            id="useAiImages"
            type="checkbox"
            checked={useAiImages}
            ...
            className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 bg-white mr-2 disabled:opacity-50"
          />
      ...
      <div>
        <label htmlFor="includeSubtitles" className="flex items-center text-sm font-medium text-gray-700 mb-1 cursor-pointer select-none">
          <input
            id="includeSubtitles"
            type="checkbox"
       ...
       {ttsSupported && (
        <div>
          <label htmlFor="enableTTS" className="flex items-center text-sm font-medium text-gray-700 cursor-pointer select-none">
            <input
              id="enableTTS"
              type="checkbox"
      ...
      <button
        ...
        className={`w-full flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white
                  ${!canGenerate ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-indigo-500'}
