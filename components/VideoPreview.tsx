      ...
      <div className="mt-3 flex items-center justify-between space-x-2">
        <div className="flex items-center space-x-2">
          <button
            ...
            className="p-2 rounded-full bg-gray-800 hover:bg-gray-700 disabled:opacity-50 transition-colors text-teal-400 hover:text-teal-300"
          ...
          >
           ...
           <button
            ...
            disabled={scenes.length === 0 || isGenerating || isDownloading}
            className="p-2 rounded-full bg-gray-800 hover:bg-gray-700 disabled:opacity-50 transition-colors text-sm text-teal-400 hover:text-teal-300"
            aria-label="Restart"
          >
            Restart
          </button>
        ...
        <button
          ...
          disabled={scenes.length === 0 || isGenerating || isDownloading}
          className="flex items-center px-3 py-2 sm:px-4 sm:py-2.5 bg-teal-600 hover:bg-teal-500 disabled:opacity-50 text-white text-xs sm:text-sm font-medium rounded-md shadow-sm transition-colors"
          aria-live="polite"
        >
